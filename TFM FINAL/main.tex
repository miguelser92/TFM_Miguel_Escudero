...
% TODO(dato): actividad de la fuente de 22Na y duracion de cada adquisicion.
% OJO: NO tomar los 286 kBq del TFM de Jimenez Algarra. Aquel es un banco de haz
% colimado sobre UN modulo; estos datos son 159 modulos en inundacion. Mismo
% detector y misma electronica, protocolo de adquisicion distinto.
%
