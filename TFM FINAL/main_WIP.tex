...
NVIDIA GeForce GTX 1660 SUPER with an AMD Ryzen 5 3600X host.
...
%Respeta las siglas una vez invocadas. 
...
\end{tabular}
\end{table}
%Creo que aqui se podría mencionar que metodo es cual, decir los nombres. 
...
\end{tabular}
\end{table}
% De nuevo creo que no queda claro el modelo de referencia que se esta usando. 
